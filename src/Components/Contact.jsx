        ...
        <div className="flex flex-wrap">
          <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
            <div className="mb-3 w-full">
              <label
                className="block font-medium mb-[2px] text-violet-800"
            ...
            <button
              type="button"
              className="mb-6 inline-block w-full rounded bg-violet-800 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-violet-500"
            >
              Send
            </button>
          </form>
              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="inline-block rounded-md bg-teal-400-100 p-4 text-violet-800">
                      <svg
